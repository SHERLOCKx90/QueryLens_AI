...
const FooterSec = () => {
  return (
    <div className='w-full relative bottom-0 bg-green-600 text-white flex flex-col justify-center items-center p-10 sm:p-5 mt-5'>
      <div className='flex flex-col sm:flex-row justify-center sm:justify-between items-center w-full sm:px-10 md:items-start md:justify-between'>
        <div className='flex flex-col justify-center items-center sm:items-start'>
          <img src="Logo-text.svg" alt="logo-text" width={200} />
          <h3 className='text-green-200 font-medium text-lg text-center md:text-left lg:text-left'>Dynamic Data Insight Access Tool for Developers.</h3>
        </div>
        <div className='text-center my-5 font-medium text-green-200 sm:text-left'>
          <ul className='flex flex-col md:flex-col lg:flex-row sm:flex-row justify-center items-center sm:items-start gap-5'>
