...
const FeatureCard = ({imgsrc, headline, details}) => {
    return (
        <div className='flex flex-col sm:flex-row sm:items-start justify-center items-center bg-white rounded-xl sm:gap-5'>
            ...
            <div className='flex flex-col justify-start items-start p-5 sm:w-1/2'>
                <h1 className='text-3xl font-semibold text-black'>{headline}</h1>
