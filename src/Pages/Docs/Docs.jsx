            ...
            <div className='px-5 md:px-10 overflow-x-hidden'>
                ...
                <div className='prose max-w-none text-left'>
                    <p>
                        Welcome to the QueryLensAI Documentation—a comprehensive resource hub
                        designed to guide developers and data professionals in seamlessly
                        integrating, configuring, and customizing QueryLensAI.
                    </p>
                    <p>
                        Our documentation ensures that developers have the tools and information
                        required to implement and optimize QueryLensAI effectively. Here&apos;s a
                    ...
                    <h3>1. Environment Setup</h3>
                    <p>Setting up the QueryLensAI development and runtime environment:</p>
                    <ul>
                        <li>
                            <strong>Conda Configuration</strong>:
                            <ul>
                                <li>Creating and managing the environment using <code>environment.yml</code>.</li>
                                <li>
                                    Required dependencies: Python 3.11, <code>numpy</code>, <code>pandas</code>,
                                    <code>fastapi</code>, <code>langchain</code>, and <code>llama-index</code>.
                                </li>
                                <li>
                                    <strong>Command Examples</strong>:
...
conda activate querylensai`}
                    ...
                    <h3>2. API Integration</h3>
                    <p>QueryLensAI’s API layer allows seamless interaction between users and the backend system.</p>
                    <ul>
                        <li>
                            <strong>API Endpoints</strong>:
                            <ul>
                                ...
                                <li>
                                    <strong>Dataset Listing (<code>/get-dataset-lov</code>)</strong>:
                                    <ul>
                                        <li>Retrieves a list of available datasets.</li>
                                        <li>
                                            Example Response:
                                            <div className='mockup-code w-full overflow-x-auto'>
                                                <pre data-prefix="~$">
                                ...
                                <li>
                                    <strong>Query Endpoint (<code>/get_answer</code>)</strong>:
                                    <ul>
                                        <li>Processes natural language queries and provides responses.</li>
                                        <li>
                                            Input Example:
                                            <div className='mockup-code w-full overflow-x-auto'>
                                                <pre data-prefix="~$">
  ...
  "answer": "The total population for counties with poverty rates above 20% is 1,200,000."
                    ...
                    <h3>3. Query Examples</h3>
                    <p>Constructing effective natural language queries:</p>
                    <ul>
                        <li>
                            <strong>Example 1</strong>:
                            <ul>
                                ...
                                <li>
                                    <strong>Transformation</strong>:
                                    <ul>
                                        <li>Filter rows where <code>Population &gt; 1,000,000</code>.</li>
                                        <li>Calculate the average of the <code>Income</code> column.</li>
                                    </ul>
                                </li>
                                <li>
                                    <strong>Result</strong>:
